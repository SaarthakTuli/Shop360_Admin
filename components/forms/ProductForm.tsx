        ...
        >
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>
                  Images<span className="text-rose-500 ml-1">*</span>
                </FormLabel>
                <FormControl>
                  <ImageUpload
          ...
          <div className="grid grid-cols-3 gap-8">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>
                    Price<span className="text-rose-500 ml-1">*</span>
                  </FormLabel>
                  <FormControl>
                    <Input
                      type="number"
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>
                    Size<span className="text-rose-500 ml-1">*</span>
                  </FormLabel>
                  <Select
                    disabled={isLoading}
                    onValueChange={field.onChange}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>
                    Color<span className="text-rose-500 ml-1">*</span>
                  </FormLabel>
                  <Select
                    disabled={isLoading}
                    onValueChange={field.onChange}
                      ...
                      {colors.map((color) => (
                        <SelectItem key={color.id} value={color.id}>
                          <div className="flex justify-between items-center gap-x-2">
                            {color.name}
                            <div
                              className="w-6 h-6 rounded-full border mr-auto"
